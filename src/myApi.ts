...
export interface AccUnlockedReq {
  /** @format int32 */
  userId?: number;
}

export type AccUnlockedResp = object;

export interface AccUnlockedRespApiRespBase {
  ret: EnumRet;
  /** @minLength 1 */
  msg: string;
  /** @minLength 1 */
  traceId: string;
  data?: AccUnlockedResp;
}
...
export interface AddHomepageTopReq {
  /**
   * @format int32
   * @min 1
   * @max 32767
  ...
  articles: AddTopArticle[];
}

export type AddHomepageTopResp = object;

export interface AddHomepageTopRespApiRespBase {
  ret: EnumRet;
  /** @minLength 1 */
  msg: string;
  /** @minLength 1 */
  traceId: string;
  data?: AddHomepageTopResp;
}
...
export interface AddTopArticle {
  /**
   * @format int32
   * @min 1
   * @max 2147483647
...
/** @format int32 */
export enum EnumMessageCmd {
  ClearCoreFrontendsCache = 1,
  ClearCountriesCache = 2,
  ClearGamesCache = 3,
  ClearFileUploadTypeCache = 4,
  ClearLanguagesCache = 5,
  ClearFavouriteGameCache = 6,
  ClearCdnCache = 7,
  ClearFrontendSiteSettingV5 = 8,
  ClearFrontendSiteSettingV6 = 9,
  ClearCoreSiteSections = 10,
  ClearBoPermissionCache = 11,
  PermissionChanged = 101,
}
...
export interface FeatureBoxFrontend {
  /**
   * Frontend Id
   * @format int32
   */
...
export interface GetFeatureBoxesFrontendsResp {
  frontends?: FeatureBoxFrontend[] | null;
}

export interface GetFeatureBoxesFrontendsRespApiRespBase {
  ret: EnumRet;
  /** @minLength 1 */
  msg: string;
  /** @minLength 1 */
  traceId: string;
  data?: GetFeatureBoxesFrontendsResp;
}
...
export interface GetFrontendLocaleOptionsResp {
  /** Locale options */
  localeOptions: Record<string, Int16Item[] | null>;
}
...
export interface GetHomepageTopDetailResp {
  topArticles?: HomepageTopDetail[] | null;
}

export interface GetHomepageTopDetailRespApiRespBase {
  ret: EnumRet;
  /** @minLength 1 */
  msg: string;
  /** @minLength 1 */
  traceId: string;
  data?: GetHomepageTopDetailResp;
}

export interface GetHomepageTopResp {
  siteSections: HomepageTopSiteSection[];
}

export interface GetHomepageTopRespApiRespBase {
  ret: EnumRet;
  /** @minLength 1 */
  msg: string;
  /** @minLength 1 */
  traceId: string;
  data?: GetHomepageTopResp;
}
...
export interface HomepageTopDetail {
  /**
   * Editorial Feature boxes Id
   * @format int32
   */
  id: number;
  /** @format int32 */
...
export interface HomepageTopSiteSection {
  /**
   * Site Section Id
   * @format int32
   */
...
export interface ModHomepageTopReq {
  /**
   * @format int32
   * @min 1
   * @max 32767
   ...
   */
  siteSectionId: number;
  articles: ModTopArticle[];
}

export type ModHomepageTopResp = object;

export interface ModHomepageTopRespApiRespBase {
  ret: EnumRet;
  /** @minLength 1 */
  msg: string;
  /** @minLength 1 */
  traceId: string;
  data?: ModHomepageTopResp;
}
...
export interface ModTopArticle {
  /**
   * feature box id
   * @format int32
   * @min 1
...
export interface MsgPublishReq {
  /**
   * "BACKOFFICE_API"、"PORTAL_API"、"PORTAL_MOBILE_API"、"SCHEDULER"、"AUTH_API"、"LOGGER_API"
   * @minLength 0
   * @maxLength 100
   */
  prefix: string;
...
export type MsgPublishResp = object;

export interface MsgPublishRespApiRespBase {
  ret: EnumRet;
  /** @minLength 1 */
  msg: string;
  /** @minLength 1 */
...
export type ResendVerificationCodeResp = object;

export interface ResendVerificationCodeRespApiRespBase {
  ret: EnumRet;
  /** @minLength 1 */
  msg: string;
  /** @minLength 1 */
  traceId: string;
  data?: ResendVerificationCodeResp;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     *
     * @tags Articles
     * @name V5ArticlesFeatureBoxesFrontendsList
     * @summary Get editorial feature boxes frontend
     * @request GET:/api/v5/articles/feature-boxes/frontends
     * @secure
     */
    v5ArticlesFeatureBoxesFrontendsList: (params: RequestParams = {}) =>
      this.request<any, GetFeatureBoxesFrontendsRespApiRespBase>({
        path: `/api/v5/articles/feature-boxes/frontends`,
        method: "GET",
        secure: true,
        ...params,
      }),
     ...
     *
     * @tags Articles
     * @name V5ArticlesFeatureBoxesHomepageTopList
     * @summary Get editorial feature boxes homepage top site sections
     * @request GET:/api/v5/articles/feature-boxes/homepage-top
     * @secure
     */
    v5ArticlesFeatureBoxesHomepageTopList: (
      query: {
        /**
         * Core frontend id
         * @format int32
      ...
      this.request<any, GetHomepageTopRespApiRespBase>({
        path: `/api/v5/articles/feature-boxes/homepage-top`,
        method: "GET",
        query: query,
        secure: true,
        ...params,
     ...
     *
     * @tags Articles
     * @name V5ArticlesFeatureBoxesHomepageTopCreate
     * @summary Add editorial feature boxes homepage top
     * @request POST:/api/v5/articles/feature-boxes/homepage-top
     * @secure
     */
    v5ArticlesFeatureBoxesHomepageTopCreate: (data: AddHomepageTopReq, params: RequestParams = {}) =>
      this.request<any, AddHomepageTopRespApiRespBase>({
        path: `/api/v5/articles/feature-boxes/homepage-top`,
        method: "POST",
        body: data,
        secure: true,
     ...
     *
     * @tags Articles
     * @name V5ArticlesFeatureBoxesHomepageTopPartialUpdate
     * @summary Modify editorial feature boxes homepage top
     * @request PATCH:/api/v5/articles/feature-boxes/homepage-top
     * @secure
     */
    v5ArticlesFeatureBoxesHomepageTopPartialUpdate: (data: ModHomepageTopReq, params: RequestParams = {}) =>
      this.request<any, ModHomepageTopRespApiRespBase>({
        path: `/api/v5/articles/feature-boxes/homepage-top`,
        method: "PATCH",
        body: data,
        secure: true,
     ...
     *
     * @tags Articles
     * @name V5ArticlesFeatureBoxesHomepageTopDetailList
     * @summary Get editorial feature boxes homepage top detail
     * @request GET:/api/v5/articles/feature-boxes/homepage-top/detail
     * @secure
     */
    v5ArticlesFeatureBoxesHomepageTopDetailList: (
      query: {
        /**
         * @format int32
         * @min 1
      ...
      this.request<any, GetHomepageTopDetailRespApiRespBase>({
        path: `/api/v5/articles/feature-boxes/homepage-top/detail`,
        method: "GET",
        query: query,
        secure: true,
        ...params,
     ...
     *
     * @tags BoAuth
     * @name V5OauthResendMfaCreate
     * @summary Resend MFA verification code to email
     * @request POST:/api/v5/oauth/resend-mfa
     * @secure
     */
    v5OauthResendMfaCreate: (params: RequestParams = {}) =>
      this.request<any, ResendVerificationCodeRespApiRespBase>({
        path: `/api/v5/oauth/resend-mfa`,
        method: "POST",
        secure: true,
        ...params,
      }),
     ...
     *
     * @tags BoAuth
     * @name V5OauthVerifyMfaCreate
     * @summary Verify MFA
     * @request POST:/api/v5/oauth/verify-mfa
     * @secure
     */
    v5OauthVerifyMfaCreate: (data: VerifyMfaReq, params: RequestParams = {}) =>
      this.request<any, OAuthTokenRespApiRespBase>({
        path: `/api/v5/oauth/verify-mfa`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     *
     * @tags BoAuth
     * @name V5AccountUnlockedPartialUpdate
     * @summary Account unlocked
     * @request PATCH:/api/v5/account-unlocked
     * @secure
     */
    v5AccountUnlockedPartialUpdate: (data: AccUnlockedReq, params: RequestParams = {}) =>
      this.request<any, AccUnlockedRespApiRespBase>({
        path: `/api/v5/account-unlocked`,
        method: "PATCH",
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     *
     * @tags Message
     * @name V5PublishCreate
     * @summary Message publish
     * @request POST:/api/v5/publish
     * @secure
     */
    v5PublishCreate: (data: MsgPublishReq, params: RequestParams = {}) =>
      this.request<any, MsgPublishRespApiRespBase>({
        path: `/api/v5/publish`,
        method: "POST",
        body: data,
        secure: true,
     ...
     *
     * @tags Options
     * @name V5OptionsMenuTypesList
     * @summary Get menu type options
     * @request GET:/api/v5/options/menu-types
     * @secure
     */
    v5OptionsMenuTypesList: (params: RequestParams = {}) =>
      this.request<any, Int16ItemListApiRespBase>({
        path: `/api/v5/options/menu-types`,
        method: "GET",
        secure: true,
        ...params,
      }),
     ...
     * @summary User crew setting (IsCrew、 EnableMfa)
